...
rem Enable KB3063109: Hyper-V Integration Services for Windows 10 hosts
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Virtual Machine\Guest\Parameters" /v HostingSystemOSMajor /t REG_DWORD /d 10 /f
